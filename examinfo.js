...
window.renderExamInfo=function(targetId){
 ...
 var ROOMS=[
  ['🇹🇭','ภาษาไทย','20%','#9C7B3F','ฟัง-พูด สื่อสาร · อ่าน-เขียนเริ่มต้น · เล่าเรื่อง คำศัพท์ตามวัย'],
  ['🔤','ภาษาอังกฤษ','20%','#E07A2F','เทียบมาตรฐาน CEFR (Pre-A1/A1/A2) · ฟัง คำศัพท์ ประโยคง่าย'],
  ['🔢','คณิต-ตรรกะ','25%','#1A7F5A','จำนวน-การนับ · รูปทรง · แบบรูป · เชาวน์เชิงตรรกะ'],
  ['🧠','EF / เชาวน์','20%','#3457B2','ความจำใช้งาน · ยับยั้งชั่งใจ · ยืดหยุ่นความคิด · เมทริกซ์'],
  ['✋','กล้ามเนื้อ','15%','#8A4FB3','มัดใหญ่ (ทรงตัว ประสานงาน) · มัดเล็ก (เขียน-ตัด-วาด)']
 ];
 var LEVELS=[
